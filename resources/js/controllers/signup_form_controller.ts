...
export default class extends Controller {
    ...
    declare readonly handleTarget: HTMLInputElement;
    declare readonly handleErrorTarget: HTMLElement;
    ...
    validateHandle() {
        ...
        this.handleErrorTarget.textContent = error;
        this.handleErrorTarget.hidden = !error;
    }
